...
public class CrearUsuarios extends AppCompatActivity {
    ...
    TextView titulorol;
    String opciones ="",usuario,nombre, contrasena,contrasenav,correo, reciberol;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(opciones.equals("crear")) {
            if(reciberol.equals("superusuario")){
                grupoRoles.setVisibility(View.INVISIBLE);
                titulorol.setVisibility(View.INVISIBLE);
            }
    ...
    private void referenciar(){
        ...
        titulorol = findViewById(R.id.txtTituloRol);
    }
    ...
    private void verificarDatosUsuario(){
        ...
        if (rolgest.isChecked())
            ...
            nombreRol="basico";
        else if(reciberol.equals("superusuario"))
            nombreRol="administrador";
        else nombreRol="";

        if (!nombreRol.isEmpty() && opciones.equals("crear")) {
